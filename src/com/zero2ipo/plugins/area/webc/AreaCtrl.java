...
public class AreaCtrl extends BaseCtrl{
	...
	private static String MenuCodeId="area_code";
	/**
	 * @title: 初始化代码管理页面
	...
	public ModelAndView initCodeManage(){
		ModelAndView mv = new  ModelAndView("/s9/area/area_init.jsp");
		try {
			if(!StringUtil.isNullOrEmpty(MenuCodeId)){
				Map<String,Object> queryMap=new HashMap<String, Object>();
				queryMap.put("codeType",MenuCodeId);
				CodeSort bo = codeManage.findCodeSortByMap(queryMap);
	...
	public ModelAndView forInitSaveCodeInfo(String codeSortId,String codeType ,String pcode,String codeId){
		ModelAndView mv = new ModelAndView("/s9/area/area_add.jsp");
		try {
			mv.addObject("codeSortId", codeSortId);
	...
	public ModelAndView forInitUpdateCodeInfo(String codeId){
		ModelAndView mv = new ModelAndView("/s9/area/area_upd.jsp");
		try {
			CodeInfo bo = null;
