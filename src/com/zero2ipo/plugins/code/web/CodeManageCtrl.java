 ...
 */
package com.zero2ipo.plugins.code.web;
...
public class CodeManageCtrl extends BaseCtrl{
     ...
     */
	@RequestMapping("initCodeManage.shtml")
	public ModelAndView initCodeManage(){
		ModelAndView mv = new  ModelAndView("/s9/code/codeManage_init.jsp");
		return mv;
	}
    ...
    public ModelAndView initCodeSortAndItem(String codeSortId){
		ModelAndView mv = new ModelAndView("/s9/code/codeSortAndItem_init.jsp");
		try {
			if(!StringUtil.isNullOrEmpty(codeSortId)){
				Map<String,Object> map=new HashMap<String, Object>();
				map.put("codeSortId",codeSortId);
				CodeSort bo = codeManage.findCodeSortByMap(map);
    ...
    public ModelAndView forInitUpdateCodeSort(String codeSortId){
		...
		try {
			...
			m.put("codeSortId",codeSortId);
			if(!StringUtil.isNullOrEmpty(codeSortId)){
				bo = codeManage.findCodeSortByMap(m);
			}
			mv.addObject("codeSortObj", bo);
    ...
    public ModelAndView forInitSaveCodeInfo(String codeSortId,String codeType ,String pcode,String codeId){
    	ModelAndView mv = new ModelAndView("/s9/code/codeItem_add.jsp");
		try {
			mv.addObject("codeSortId", codeSortId);
    ...
    public ModelAndView forInitUpdateCodeInfo(String codeId){
    	ModelAndView mv = new ModelAndView("/s9/code/codeItem_upd.jsp");
		try {
			CodeInfo bo = null;
