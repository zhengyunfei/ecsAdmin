package com.zero2ipo.eeh.AttendanceSetting.bizc.impl;
 ...
 */
@Service("AttendanceSettingService")
public class AttendanceSettingServiceImpl implements IAttendanceSettingService {
    @Autowired
    @Qualifier("baseDao")
    ...
    public final static String common="AttendanceSetting";
    ...
    public AttendanceSettingBo findById(String id){
        AttendanceSettingBo bo=null;
        try {
            baseDao.setDbType(FwConstant.DBTYPE_GLOBAL) ;
            Map<String,Object> queryMap=new HashMap<String,Object>();
            queryMap.put("id", id);
            bo = (AttendanceSettingBo) baseDao.findForObject(FINDBYID, queryMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return bo;
