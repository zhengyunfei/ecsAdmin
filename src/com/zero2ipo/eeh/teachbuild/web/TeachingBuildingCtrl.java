package com.zero2ipo.eeh.teachbuild.web;
...
public class TeachingBuildingCtrl extends BaseCtrl {
    @Autowired
    ...
    public Map<String,Object> findAllList(String curNo, String curSize){
        ...
        try {
            ...
            int total=0;
            total=teachingBuildingService.getTotal(map);
            List<TeachingBuildingBo> list= null;
            if(total>0){
                list = teachingBuildingService.findAllList(map, (skip-1)*max, max);
            }
 ...
 /******************************************新增*********************************************************/
    ...
    @ResponseBody
    public Map<String,Object> addSave(TeachingBuildingBo bo) {
        Map<String,Object> result=new HashMap<String,Object>();
        boolean flg=false;
        try {
            flg=teachingBuildingService.add(bo);
        } catch (Exception e) {
            flg=false;
            e.printStackTrace();
    ...
    public ModelAndView forUpdateInitPage(String id) {
        ...
        TeachingBuildingBo bo=teachingBuildingService.findById(id);
        mv.addObject("bo",bo);
        return mv;
    }
    /**
    ...
    @ResponseBody
    public Map<String,Object> updateSave(TeachingBuildingBo bo) {
        Map<String,Object> result=new HashMap<String,Object>();
        boolean flg=false;
        try {
            flg=teachingBuildingService.update(bo);
        } catch (Exception e) {
            flg=false;
            e.printStackTrace();
    ...
    public Map<String,Object> delSave(String ids) {
        ...
        boolean flg=false;
        try {
            flg=teachingBuildingService.delete(ids);
        } catch (Exception e) {
            flg=false;
            e.printStackTrace();
