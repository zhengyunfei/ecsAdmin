        ...
        try {
            ...
            if (fileitemIndex.hasNext()) {
                ...
                if (file.isFormField()) {
                    ...
                    out.print("<font color=\"red\"size=\"2\">上传文件非法！isFormField=true</font>");
                }
                ...
                if (logger.isInfoEnabled()) {
                    out.print("上传文件结束，新名称:" + fileClientName + ".floder:"
                            + newfile.getPath());
                }

                // 组装返回url，以便于ckeditor定位图片
                fileUrl = "/c/"+FOR_FREEMARKER_LOAD_DIR + FILE_UPLOAD_DIR + FILE_UPLOAD_SUB_IMG_DIR + File.separator+floder.getName()+ File.separator + newfile.getName();
