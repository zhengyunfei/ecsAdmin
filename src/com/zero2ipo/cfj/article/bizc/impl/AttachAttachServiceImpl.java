package com.zero2ipo.cfj.Attach.bizc.impl;

import com.zero2ipo.cfj.article.bizc.IArticleAttachService;
...
public class AttachAttachServiceImpl implements IArticleAttachService {
    @Autowired
    @Qualifier("baseDao")
    private IBaseDao baseDao;
    public final static String common="Attach";
    ...
    public AttachBo findById(String id){
        ...
        try {
            ...
            queryMap.put("id", id);
            bo = (AttachBo) baseDao.findForObject(FINDBYID, queryMap);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return bo;
