...
<html>
	<head>
		...
		<!-- 用户管理操作JS静态资源的引用 -->
			...
			<script type="text/javascript" src="<%=basePath %>/eeh/Timetable/js/teacherUpload.js"></script>
	</head>
	<body class="z-body-detail" style="overflow: hidden">
							...
							<div class="z-toolbar-ct">
								<div class="z-toolbar-overflow">
									<div class="z-toolbar-nowrap">
										...
										<select id="gradeName" onchange="selectGrade()">
		...
		<script type="text/javascript">
			...
			//下载标准课程表
		   function download(){
				window.location.href="<%=basePath%>/eeh/excel/表格七:单一班级课程表样例.xlsx";
		   }
		   function selectGrade(){
			   var gradeName=$("#gradeName").val();//班级名称
			   var url='../Timetable/findAllList.shtml?gradeName='+gradeName;
			   findAllList(url);
		   }
		</script>
	</body>
