...
<head>
	...
	<script type="text/javascript" src="<%=basePath %>/eeh/Seat/js/setSeatUpload.js?v=1"></script>
</head>

<body class="dialogBody">
<form id="form1" onsubmit="return false;"
	  action="../Seat/forAddAjax.shtml" name="form1" method="post">
	<input type="hidden" id="gradeId" name="gradeId" value="${id}"/>
						...
						<div class="z-toolbar-overflow">
							<div class="z-toolbar-nowrap">
								<a href="javascript:download();" class="z-btn z-btn-flat">
									<img class="icon021a12" ><b>下载座位表<i></i></b>
								</a>
