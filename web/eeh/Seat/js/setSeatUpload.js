$(function() {
    $("#importExcel").uploadify({
       ...
       'onUploadSuccess' : function(file, data, response){
           ...
           var id=$("#id").val();
           $.ajax({
               url:"../Seat/delByMap.shtml?id="+id+"&seatType=0",
               type:"post",
               dataType:"json",
               data:data,
               async:false,
               ...
               success:function(msg){
                   if(msg.success){
                       var url="../excelOperate/importExcelForGradeSeat.shtml?gradeId="+id;
           ...
           var url="../excelOperate/importExcelForGradeSeat.shtml?gradeId="+gradeId;
           var data={"path":filepath};
           ajaxImport(url,data);
    },
