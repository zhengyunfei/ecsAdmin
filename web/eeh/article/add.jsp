...
<html>
  <head>
	  ...
	  <script type="text/javascript" src="<%=basePath%>/web/ckeditor/config.js?v=1"></script>
		...
		<div class="z-toolbar-nowrap">
          ...
          <table width="100%" >
           <tbody>
			...
			<tr style="display: none" id="selectGradeTr">
				<td height="28"  align="right" style="padding-right: 5px;" nowrap="nowrap">
           ...
           <tr>
			...
			<tr>
				...
				<td>
					<input name="time"  type="text" id="time" style="width:300px" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" class="Wdate" />
				</td>
			</tr>
            <tr>
	            <td height="28" align="right" style="padding-right: 5px;" nowrap="nowrap" id="thumbnailTr">
           ...
           <td class="xheIframeArea">
			...
			<tr style="display: none" id="mottoTr">
				...
				<td>
				<textarea rows="" cols="" style="width:300px" id="motto" name="motto"  >
			...
			<tr style="display: none" id="remarkTr">
				...
				<td>
					<textarea rows="" cols="" style="width:300px" id="remark" name="remark"  >
