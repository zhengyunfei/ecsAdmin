...
<html>
	<head>
		...
		<!-- 用户管理操作JS静态资源的引用 -->
		    <!-- JS静态资源的引用 -->
			<script type="text/javascript" src="<%=basePath%>/eeh/Course/js/list.js"></script>
	...
	<body class="z-body-detail" style="overflow: hidden">
		...
		<script type="text/javascript">
			...
			//下载标准课程表
			function download(){
				window.location.href="<%=basePath%>/eeh/excel/表格四：培优课课程表1.xlsx";
			}
			function selectGrade(){
				var gradeName=$("#gradeName").val();
				var url='../Course/findAllList.shtml?classRoom='+gradeName;
				findAllList(url);
			}
		</script>
	</body>
