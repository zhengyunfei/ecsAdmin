...
<html>
	<head>
		<title>修改角色</title>
		<!-- JS动态资源的引用 -->
		<script type="text/javascript" src="<%=basePath %>/s9/role/js/roleManage_upd.js"></script>
	</head>
	<body class="z-body-detail">
		<form action="../sysRole/updRole.shtml" id="updRole" name="updRole" method="post">
		...
		<table width="100%" height="*" border="0" cellspacing="0"
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" id="roleNo" name="roleNo" value="${role.roleNo }">
				...
				<tr>
				 <td colspan="2" class="aui_footer">
					 <div class="aui_buttons">
						<button value="保存" id="z-dialog-1-OKButton" onclick="forSaveUpdRole();" class="z-dlg-button z-dialog-okbutton aui_state_highlight">保存</button>
					</div> 
				 </td>
				</tr>
			</tbody>
