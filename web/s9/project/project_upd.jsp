...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath %>/s9/project/js/update.js?version=1"></script>
		<script type="text/javascript" src="<%=basePath %>/s9/project/js/number.js?version=1"></script>
	</head>

	<body class="dialogBody">
		<form id="form1" onsubmit="return validData()"
			action="../serviceProject/updProject.shtml" name="form1" method="post">
								...
								<tr>
									...
									<td width="90%" >
										<input type="text" id="price" name="price"
											style="width: 300px" value="${bo.price}" onkeyup="clearNoNum(this)"/>
										<span
											style="color: red; padding-left: 2px; padding-top: 13px;">*</span>
									</td>
								</tr>
								<tr>
									...
									<td width="90%" >
										<input type="text" id="orignPrice" name="orignPrice"
											style="width: 300px" value="${bo.orignPrice}" onkeyup="clearNoNum(this)"/>
										<span
											style="color: red; padding-left: 2px; padding-top: 13px;">*</span>
									</td>
								</tr>
								<tr>
									...
									<td width="90%" >
										<textArea rows="3" id="remark" name="remark"
											style="width: 300px">${bo.remark}</textArea>
									</td>
								</tr>
								<tr>
