...
<script type="text/javascript" src="<%=basePath %>/s9/code/js/codeSortAndItem_init.js?version=1"></script>
	<script type="text/javascript">
		//初始化加载数据
		 $(function (){ 
		     var url = "../codeManage/findCodeInfoList.shtml?codeSortId=${codeSortObj.codeSortId}";
		       	initChildData(url);
		    });  
	</script>
