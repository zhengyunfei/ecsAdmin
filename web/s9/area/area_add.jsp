...
<html>
	...
	<body>
		<form action="<%=basePath %>/area/addCodeInfo.shtml" id="theForm" name="theForm" method="post">
		<table width="100%" height="*" border="0" cellspacing="0" cellpadding="0">
			<tbody>
			   ...
			   <tr>
					...
					<td>
						<input type="text" id="content1" name="content1"  style="width: 75%;">
					</td>
				</tr>
				<tr>
					<td  height="30" align="right">
				...
				<tr>
					...
					<td>
						<input type="text" id="content3" name="content3"  style="width: 75%;">米
					</td>
				</tr>
				<tr>
		 ...
		 <div class="aui_buttons">
			...
			<%--<div>
				要查询的地址：<input id="codeName" type="text" value="" style="margin-right:100px;"/>
