...
<script type="text/javascript" src="<%=basePath%>/s9/yqh/js/add.js"></script>
...
<body class="z-body-detail" style="background-color:white;height:1000;overflow: hidden;" >
   	<form onsubmit="return false" action="../invitationLetter/addSave.shtml" id="form1" name="form1" method="post">
   	<input type="hidden" id="createUser" name="createUser" value="${user.userName}"/>
    ...
    <td align="left" id="trToolbar">
		...
		<div class="z-toolbar-nowrap">
          ...
          <table width="100%" cellpadding="12" cellspacing="10">
           ...
           <tr>
            <td height="28" align="right" style="padding-right: 5px;" nowrap="nowrap"><font color="#ff0000">*</font><span class="dye">简称：</span>
            </td>
            <td colspan="3" align="left"><input name="shortName" type="text" style="width: 380px;" id="shortName" size="50" ></td>
           </tr>
            <tr>
            <td height="28" align="right" style="padding-right: 5px;" nowrap="nowrap"><font color="#ff0000">*</font><span class="dye">二级标题：</span>
            </td>
           ...
           <td class="xheIframeArea">
        	 <div id="ckeditor" style="height:100%"></div>
        	  <textarea id="content" name="content" cols="" rows="" style="display: none"></textarea>
        	 <div style="padding-top: 10px;"></div>
           </td>
           </tr>
             <tr>
            <td height="28" align="right" style="padding-right: 5px;" nowrap="nowrap"><font color="#ff0000">*</font><span class="dye">地点：</span>
            </td>
            	<td colspan="3" align="left"><input name="area" type="text" id="area" style="width: 380px;">
            </td>
           </tr>
            <tr>
				<td width="30%" height="40" align="right" style="padding-right: 5px;" nowrap="nowrap"><font color="#ff0000">*</font><span class="dye" >
					下发开始时间：</span>
				</td>
				<td> 
					<input name="sendStartTime" style="width:380px;" value="${sendTime}" type="text" id="sendStartTime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" class="Wdate" />
				</td>
			</tr>
			 <tr>
				<td width="30%" height="40" align="right" style="padding-right: 5px;" nowrap="nowrap"><font color="#ff0000">*</font><span class="dye" >
				...
				<td> 
					<input name="sendEndTime"  style="width:380px;" value="${sendTime}" type="text" id="sendEndTime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})" class="Wdate" />
				</td>
			</tr>
			 <tr>
				<td width="30%" height="40" align="right" style="padding-right: 5px;" nowrap="nowrap"><font color="#ff0000">*</font><span class="dye" >
				...
				<td> 
					<input name="startTime" style="width:380px;" value="${sendTime}" type="text" id="startTime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})" class="Wdate" />
				</td>
			</tr>
			 ...
			 <tr>
				...
				<td> 
					<input name="url" style="width: 380px;" type="text" id="url"  />
				</td>
			</tr>
               <tr>
            <td height="28" align="right" style="padding-right: 5px;" nowrap="nowrap"><span class="dye">缩略图：</span>
            	...
            	<td colspan="3" align="left">
            	 <input type="text" name="attachmentUrl"  id="attachmentUrl" style="width: 380px;" onclick="CKEDITOR.tools.callFunction(4, this); return false;"/>
            	   <input type="hidden" id="shortImage" name="shortImage"/>
          ...
          <tr>
           <td></td>
           	<td colspan='1'>
           		<image id="imgView"  src='${bo.shortImage}' style="width:200px;height:200px;display:none"></image>
           	</td>
           </tr>
