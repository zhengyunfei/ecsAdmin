...
<html>
	<head>
		...
		<!-- 用户管理操作JS静态资源的引用 -->
			...
			<script type="text/javascript" src="<%=basePath%>/s9/paidan/js/list.js?v=4"></script>
							...
							<div class="z-toolbar-ct">
								<div class="z-toolbar-overflow"> 
									<div class="z-toolbar-nowrap">
										...
										<a href="javascript:void(0);" id="Button6" class="z-btn z-btn-flat" onclick="update();">
