...
combox.prototype.buildBase = function(){
    ...
    if(this.originElPos.height<1){
    	this.originElPos.height=20;
    }
    ...
    _btn1.type = 'button';
    if(this.originElPos.height<10){
    	this.originElPos.height=20;
    }
    _btn1.style.height = _addUnit(this.originElPos.height);
    if(this.dropDownBtnWidth<20){
    	this.dropDownBtnWidth=30;
    }
    ...
    _div2.style.width = '136px';
     if($("#type").val()!=1){
    	  _div2.style.margin = '130px 0 0 160px';
     }
