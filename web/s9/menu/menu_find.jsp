			...
			<table width="95%" height="197" align="center" style="padding: 4px"	border="1" bordercolor="#eeeeee">
				<tbody>
					<tr>
						...
						<td width="75%">
							<input type="text" name="menuName" id="menuName" value="${sysMenu.menuName }" />
						</td>
					</tr>
					<tr>
						<td align="left" bgcolor="#F7F7F7"> &nbsp;&nbsp;
						...
						<td>
							<input type="text" name="pmenuCode" id="pmenuCode" value="${sysMenu.pmenuCode }"/>
						</td>
					</tr>
					<tr>
						<td align="left" bgcolor="#F7F7F7"> &nbsp;&nbsp;
						...
						<td>
							 <input type="text" name="menuCode" id="menuCode" value="${sysMenu.menuCode} ">
						</td>
					</tr>
					<tr>
						<td align="left" bgcolor="#F7F7F7"> &nbsp;&nbsp;
					...
					<tr>
						...
						<td>
							<input type="text" name="pathCode" id="pathCode" value="${sysMenu.pathCode }" />
						</td>
					</tr>
					<tr>
						<td align="left" bgcolor="#F7F7F7">
						...
						<td>
							<input type="text" name="sortNo" id="sortNo" value="${sysMenu.sortNo }" />
						</td>
					</tr>
					<tr>
						<td align="left" bgcolor="#F7F7F7"> &nbsp;&nbsp;
						...
						<td>
							<input type="text" name="remark" id="remark" value="${sysMenu.remark }" />
						</td>
					</tr>
				</tbody>
			</table>
