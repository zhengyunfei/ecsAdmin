...
<html>
	<head>
		...
		<!-- 用户管理操作JS静态资源的引用 -->
			...
			<script type="text/javascript" src="<%=basePath%>/s9/coupon/js/list.js?v=2"></script>
	...
	<body class="z-body-detail" style="overflow: hidden">
						...
						<div class="z-toolbar" id="ToolBar1" >
							<div class="z-toolbar-ct">
								<div class="z-toolbar-overflow"> 
									...
									<a href="javascript:void(0);" id="addBtn" class="z-btn z-btn-flat" onclick="add();">
											<img class="icon021a2" src="../s9/res/img/icon000.png"><b>新增<i></i></b>
									</a> 
									<a href="javascript:void(0);" id="updBtn" class="z-btn z-btn-flat" onclick="update();">
										<img class="icon021a3" src="../s9/res/img/icon000.png"><b>修改<i></i></b>
									</a> 
									<a href="javascript:void(0);" id="delBtn" class="z-btn z-btn-flat" onclick="del();">
		...
		<script type="text/javascript">
			// 初始化加载
			$(function(){
				var url='../coupon/findAllList.shtml';
				findAllList(url);
			})
